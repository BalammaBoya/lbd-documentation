#+TITLE: LbD based Course Content Development in the areas of CS and ECE Documentation
...
* Introduction
** General Information
Project Title: Learning by Doing (LbD) based course content development for 17 courses in areas of CS and ECE
...
** Project Overview
It is natural for one to be more interested if one is involved in what
...
* Development Process of courses

** About The Butterfly Model
The basis of the model Butterflies symbolize change. In ancient mythology, the
...
*** Learning objectives:
The "Learning Objectives" put together form the concepts the courses covers.
...
*** Implementation: 
The "Implementation" Involves tasks when completed lead to prototypes of basics products in the area.
...
*** Concepts: 
The "Concepts" when concatenated form a lecture-based course.
...
*** Resources: 
The "resources" form a collection of various multi-model resources including the breakthrough papers in the area.
...
*** Illustration:
The "Illustration" form an (animated e-workbook with solved examples.
...
*** Playground:
The "playground" forms a virtual workshop for the courses
...
*** Analysis:  
The "Analysis" forms detailed versions of the "truths" in the courses (like mathematical proofs).
...
*** Insights: 
The "Insights" trace the literature's evolution leading to the entire course.
...
*** Imagination: 
"Imagination" is about the research idea "explosion" aftermath of the
...
** List of the courses
The following courses are designed LbD using butterfly model.
...
+ Submitted courses list:

  1) [[http://enhanceedu.iiit.ac.in/moodle/course/view.php?id=46][Social Networking]] 
  2) [[http://enhanceedu.iiit.ac.in/moodle/course/view.php?id=44][Advanced Topics in Text and Web Mining]]
  3) [[http://enhanceedu.iiit.ac.in/moodle/course/view.php?id=27][Operating Systems]]
  4) [[http://enhanceedu.iiit.ac.in/moodle/course/view.php?id=31][Solid State Electronic Devices]]
  5) [[http://enhanceedu.iiit.ac.in/moodle/course/view.php?id=37][Algorithms]]
  6) [[http://enhanceedu.iiit.ac.in/moodle/course/view.php?id=34][Embedded Systems]]
  7) [[http://enhanceedu.iiit.ac.in/moodle/course/view.php?id=33][Digital Systems Design using Verilog]]
  8) [[http://enhanceedu.iiit.ac.in/moodle/course/view.php?id=32][Data Mining and Data Warehousing]]
  9) [[http://enhanceedu.iiit.ac.in/moodle/course/view.php?id=30][Introduction to e-Governance]]
  10) [[http://enhanceedu.iiit.ac.in/moodle/course/view.php?id=39][Digital Logic Design]]
  11) [[http://enhanceedu.iiit.ac.in/moodle/course/view.php?id=41][Analog Design]]


+ Working in progress courses list:

    12) [[http://enhanceedu.iiit.ac.in/wiki/index.php/LBD_Courses/EMT][Electro Magnetic Theory]]
    13) [[http://enhanceedu.iiit.ac.in/wiki/index.php/LBD_Courses/VLSI][VLSI]]
    14) [[http://enhanceedu.iiit.ac.in/moodle/course/view.php?id=42][Visual Java Development Environment]]
    15) [[http://enhanceedu.iiit.ac.in/wiki/index.php/LBD_Courses/CAD_VLSI][CAD for VLSI]]
    16) [[http://enhanceedu.iiit.ac.in/wiki/index.php/LBD_Courses/Topics_in_Embedded_Systems_Intro][Topics in Embedded Systems]]
    17) [[http://enhanceedu.iiit.ac.in/wiki/index.php/LBD_Courses/VLSI_Architectures][VLSi Architectures]]

** Authorization of the course:

Courses development was done on [[http://enhanceedu.iiit.ac.in/wiki][wiki]] and running on [[http://enhanceedu.iiit.ac.in/moodle/][moodle]] platform.

* Location of lab repositories
All 'LbD Course' are sources are stored as a [[http://enhanceedu.iiit.ac.in/wiki/][wiki]] - 'LbD Courses', which is maintained by
EnhanceEdu.

* Owner of Course repositories
The ownership of the lab repositories would reside with the EnhanceEdu team. The discretion of including new features contributed by
Professors  RA's and EnhanceEdu team.

* Development of courses repositories
All changes and new feature developments should happen only on the
wiki. 

* Hosting process of labs
Process of porting courses on the platform:

[[http://enhanceedu.iiit.ac.in/moodle/][Portal Link]]
...
#+BEGIN_EXAMPLE
Sample html code for animations 
...
*** Adding a Module for Existing course
At the end of the each section you can find Add Section button for adding a new
module
...
* Summary 
Learning by Doing (LbD) based course content development in the areas of CS and
...
* Conclusion
This document highlights the  "Lbd and Butterfly Model" detail specifications
